...
#include "require/include/Iedk.h"				//UPDATE : edk.h -> Iedk.h
#include "require/include/IedkErrorCode.h"		//UPDATE : edkErrorCode.h -> IedkErrorCode.h
#include "require/include/IEmoStateDLL.h"		//UPDATE : EmoStateDLL.h -> IEmoStateDLL.h
